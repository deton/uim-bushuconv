...
* デフォルトで使用する部首合成変換辞書(bushu34.{index2,expand})には、
  JIS第1・第2水準漢字(JIS X 0208)と第3・第4水準漢字(JIS X 0213)のみ含まれます
  (補助漢字(JIS X 0212)やUnicodeにしかない漢字は含まれません)。
